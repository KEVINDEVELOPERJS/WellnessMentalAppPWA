...
def create_final_web_document():
    """Crea el documento final de la app web con estructura completa"""
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_registro.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_login.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_consentimiento.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_dashboard_estudiante.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_dashboard_psicologo.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_cuestionarios.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_gad7.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_resultados.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_historial.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_chat.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_chat_conversacion.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_ejercicios.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_respiracion.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_meditacion.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_progreso.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_juegos.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_puzzle.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_arte.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_ritmo.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_jardin.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_logros.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_puntos.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_comunidad.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_post.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_interaccion.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_informes.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_informe_previa.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_perfil.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_privacidad.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_sesiones.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_editor.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_editor_previa.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_alertas_panel.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_alertas_detalle.png')
    )
    
    add_section_with_content(
        doc,
        'CA-Alerta.2: Panel de Alertas de Riesgo Bajo/Medio',
        'Panel web de alertas de riesgo bajo/medio',
        'alerts-low-medium.html, alerts-low-medium.js (panel web)',
        image_path=os.path.join(images_folder, 'web_alertas_bajo_medio.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_checkin.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_misiones.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_videos.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_video_reproduccion.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_pausas.png')
    )
    ...
    add_section_with_content(
        ...
        image_path=os.path.join(images_folder, 'web_pausa_config.png')
    )
    ...
    output_path = r'C:\Users\Admin\Documents\INGENIERIA DE SOFTWARE\IV SEMESTRE\ARCHIVOS (.pptx .docx .pdf .xlsx)\APPS WELLNESS MENTAL\WellnessMentalApp(WEB)\INFORME_FINAL_INTEGRADO_WEB_COMPLETO.docx'
